...
CREATE TABLE "_IngredientToPizza" (
    ...
    CONSTRAINT "_IngredientToPizza_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_CartItemToProductItem" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_CartItemToProductItem_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_CartItemToProductItem_B_index" ON "_CartItemToProductItem"("B");
...
-- AddForeignKey
ALTER TABLE "_CartItemToProductItem" ADD CONSTRAINT "_CartItemToProductItem_A_fkey" FOREIGN KEY ("A") REFERENCES "CartItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CartItemToProductItem" ADD CONSTRAINT "_CartItemToProductItem_B_fkey" FOREIGN KEY ("B") REFERENCES "ProductItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
